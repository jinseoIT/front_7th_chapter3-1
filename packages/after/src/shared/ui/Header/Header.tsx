...
export const Header: React.FC = () => {
  return (
    <header className="bg-white border-b border-gray-300 shadow-sm sticky top-0 z-modal">
      <div className="max-w-[1400px] mx-auto px-6 flex justify-between items-center h-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-500 font-semibold text-base">
            DU
          </div>
        </div>
      </div>
